...
$opt_name = 'test_theme_opt';  // YOU MUST CHANGE THIS.  DO NOT USE 'redux_demo' IN YOUR PROJECT!!!
...
Redux::set_section(
	...
	array(
		...
		'id'               => 'header',
		'desc'             => esc_html__( 'Customize header blocks', 'your-textdomain-here' ),
...
require_once Redux_Core::$dir . '../sample/sections/header/background.php';
